 ...
 * consists of consecutive integers, so we know the correct position for each element. * For
 * example, if we are given: [2, 1, 4, 3] ^
 * <p>
 ...
 * <i>swaps = 1</i>
 * <p>
 * Does the current element, 4, match (index + 1 = 3) 3? No. We know element 4 belongs at index (4 -
 * 1) 3, so we swap element 4 with the element at index 3, which is 3.
 * <p>
 * [1, 2, 3, 4] ^
 * <i>swaps = 2</i>
 * <p>
